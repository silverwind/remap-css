# remap-css
[![](https://img.shields.io/npm/v/remap-css.svg?style=flat)](https://www.npmjs.org/package/remap-css) [![](https://img.shields.io/npm/dm/remap-css.svg)](https://www.npmjs.org/package/remap-css) [![](https://packagephobia.com/badge?p=remap-css)](https://packagephobia.com/result?p=remap-css)
...
These special mapping keys are supported:

- `$border: value`: Any occurrence of `value` in a `border` rule.
- `$background: value`: Any occurrence of `value` in a `background` rule.
- `$box-shadow: value`: Any occurrence of `value` in a `box-shadow` rule.
- `$value: value`: Any occurrence of `value`.
